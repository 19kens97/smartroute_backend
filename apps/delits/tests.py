...
class DelitServiceTests(TestCase):
    ...
    def test_manual_creation_is_potential(self):
        case,created=create_potential_delit_case(detected_by=self.user,delit_type=self.type,source_type=DelitCase.SourceType.MANUAL_OBSERVATION,facts='Fuite observée après un accident.',driver_id=1)
