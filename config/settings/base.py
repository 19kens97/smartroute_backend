...
PRIVATE_DOCUMENT_ROOT = Path(config("PRIVATE_DOCUMENT_ROOT", default=str(BASE_DIR / "private" / "documents")))
PRIVATE_SCAN_ROOT = Path(config("PRIVATE_SCAN_ROOT", default=str(BASE_DIR / "private" / "scans")))
